...
//ホームページ
Route::get('/account_master/home', [App\Http\Controllers\accunt_masterController::class, 'home'])->name('home');
//アカウント一覧ページ
Route::get('/account_master/accounts', [App\Http\Controllers\accunt_masterController::class, 'accounts'])->name('accounts');
//新規会員登録ページ
Route::get('/account_master/registration',[App\Http\Controllers\accunt_masterController::class, 'registration'])->name('registration');
//確認ページ
Route::post('/account_master/confirm',[App\Http\Controllers\accunt_masterController::class, 'confirm'])->name('confirm');
//アカウントリスト
Route::get('/account_master/accounts_list',[App\Http\Controllers\accunt_masterController::class, 'accounts_list'])->name('accounts_list');
//編集ページ
Route::get('/account_master/edit/{id}',[App\Http\Controllers\accunt_masterController::class, 'edit'])->name('edit');
//修正
